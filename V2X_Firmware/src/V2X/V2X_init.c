...
void pin_init(void)
{
	...
	ioport_configure_pin(PWR_LP3V3_PIN					, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH	);  //initially, make sure 3V3 stays up
	ioport_configure_pin(PWR_M3V3_PIN					, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW	);  //4V1 sould not be on yet
}
